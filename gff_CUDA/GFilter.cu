...
// declare four streams to enable concurrence kernel launch.
    ...
    boxfilter(d_tempD_, d_tempA_, wid, hei, rad);
    boxfilter(d_tempA_, d_imgInP, wid, hei, rad);
    ...
    boxfilter(d_tempB_, d_tempD_, wid, hei, rad);
    boxfilter(d_tempD_, d_tempA_, wid, hei, rad);
